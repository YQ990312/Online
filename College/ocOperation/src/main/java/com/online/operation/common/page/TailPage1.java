 ...
 * 分页
 */
public class TailPage1<E> extends AbstractPage<E> {
     ...
     * @param items
     */
    public TailPage1(Page<E> page, Collection<E> items ,int itemsTotalCount) {
        this(page.getPageNum(), page.getPageSize(), itemsTotalCount , items);
    }

    public TailPage1(int pageNum, int pageSize , int itemsTotalCount , Collection<E> items) {
