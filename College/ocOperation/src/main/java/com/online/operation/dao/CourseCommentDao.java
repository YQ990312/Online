...
public interface CourseCommentDao {
	...
	*分页获取
	**/
	public List<CourseComment> queryPage(CourseComment queryEntity, TailPage1<CourseComment> page);
	...
	*分页获取
	**/
	public List<CourseComment> queryMyQAItemsPage(CourseComment queryEntity, TailPage1<CourseComment> page);
